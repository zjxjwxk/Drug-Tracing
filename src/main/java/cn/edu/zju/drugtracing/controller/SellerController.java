...
public class SellerController {
    ...
    @ResponseBody
    public ServerResponse<String> setSeller(@ApiParam("药品销售平台地址（输入0则为当前函数调用者地址）") @RequestParam String sellerAddr,
    ...
    public ServerResponse<String> setSellInfo(@ApiParam("药品小包编号（3bytes药品ID+3bytes大包ID+3bytes小包ID）") @RequestParam String packageID,
                                      ...
                                      @ApiParam("销售平台地址（输入0则为当前函数调用者地址）") @RequestParam String sellerAddr,
